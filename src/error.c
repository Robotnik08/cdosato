...
static const char* ERROR_MESSAGES[] = {
    ...
    "Expected Master Keyword as first token (DO, MAKE, SET, DEFINE, INCLUDE, IMPORT, RETURN, BREAK, CONTINUE, SWITCH, CONST, CLASS, IMPLEMENT, ENUM)",
    ...
    "Master keyword can't have extensions (MAKE, DEFINE, IMPORT, INCLUDE, CONST, CLASS, IMPLEMENT, ENUM)",
